    ...
    <div class="container">
        ...
        <section class="display-product-table">
            <table>
                <thead>
                    <th>product image</th>
                    <th>product name</th>
                    <th><a href="admin.php?sort=price&order=asc">↑</a> product price <a href="admin.php?sort=price&order=desc">↓</a></th>
                    <th>action</th>
                </thead>
        ...
        <section class="edit-form-container">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="update_p_id" value="<?php echo $fetch_edit
                ['id']; ?>">
